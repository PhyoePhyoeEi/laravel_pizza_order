...
<html lang="en">
    ...
    <div class="container px-4 px-lg-5" id="home">
        ...
        <div class="d-flex">
                    ...
                    <div class="py-5 text-center">
                        ...
                        <form action="{{ route('user#searchPizzaItem') }}" method="GET">
                            ...
                            <div class="text-center m-4 p-2">
                                ...
                                <input type="number" name="minPrice" value="{{ old('minPrice') }}" id="" class="form-control" placeholder="minimum price"> -
                                <input type="number" name="maxPrice" value="{{ old('minPrice') }}" id="" class="form-control" placeholder="maximun price">
                            
                            </div>
                            <div class="">
                                {{-- <input type="submit" value="Search" class="btn btn-dark text-white"> --}}
                                <button type="submit" class="btn btn-dark text-white">Search<i class="fas fa-search"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="mt-5">
                @if ($status == 1)
                <div class="d-flex justify-content-between row gx-4 gx-lg-5" id="pizza">
                ...
                @else
                    <div class="alert alert-danger text-center" role="alert" style="width: 500px; margin-top:40px;">
                        There is no Pizza! 
                    </div>
    ...
    <div class="text-center d-flex justify-content-center align-items-center" id="contact">
       ...
       @endif
            ...
            <form action="{{ route('user#createContact') }}" method="POST" class="my-4">
                ...
                <textarea class="form-control my-3" exampleFormControlTextarea1 rows="3" name="message" placeholder="Message">{{ old('message')}}</textarea>
