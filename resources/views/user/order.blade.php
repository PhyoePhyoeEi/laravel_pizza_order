...
<div class="row mt-5 d-flex justify-content-center">
        ...
        <div class="col-4 ">
            <img src="{{ asset('uploads/'.$pizza->image) }}" class="img-thumbnail" width="100%">            
        ...
        @endif
            ...
            <form action="" method="POST">
                ...
                <button class="btn btn-primary mt-5" type="submit"><i class="fas fa-shopping-cart"></i> Pace Order</button>
