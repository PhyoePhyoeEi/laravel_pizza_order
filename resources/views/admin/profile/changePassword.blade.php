                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="post" action="{{ route('admin#changePassword', Auth()->user()->id) }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="oldPassword" value="{{ old('oldPassword') }}" placeholder="Enter old password">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control"  name="newPassword" value="{{ old('newPassword') }}" placeholder="Enter new password">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="confirmPassword" value="{{ old('confirmPassword') }}" placeholder="Enter confirm password">
