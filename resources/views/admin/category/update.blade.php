                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="POST" action="{{ route('admin#updateCategory') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" hidden name="id" value="{{ $category->category_id}}">
                            <input type="text" class="form-control" name="name" placeholder="Name" value="{{ old('name', $category->category_name) }}" autofocus>
